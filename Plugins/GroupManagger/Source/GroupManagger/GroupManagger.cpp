...
FName AGroupManagger::ComponentName = TEXT("GroupManagger");
...
UTeamMatesHelperComponent* AGroupManagger::GetTeamMatesHelperComponentBase()
{
	return TeamMatesHelperComponentPtr;
}

UInventoryComponentBase* AGroupManagger::GetInventoryComponentBase()
{
