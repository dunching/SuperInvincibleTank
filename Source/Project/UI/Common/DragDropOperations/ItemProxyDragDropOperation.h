 ...
 */
UCLASS()
class PROJECT_API UItemProxyDragDropOperation : public UDragDropOperation
{
	GENERATED_BODY()
...
UCLASS()
class PROJECT_API UAllocationableProxyDragDropOperation : public UDragDropOperation
{
	GENERATED_BODY()
