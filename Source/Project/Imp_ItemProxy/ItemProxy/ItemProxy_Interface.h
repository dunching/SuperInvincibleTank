 ...
 * 如冷却、层数
 */
struct PROJECT_API IProxy_SkillState
{
public:
 ...
 * 可堆叠物品接口
 */
struct PROJECT_API IProxy_Unique
{
public:
...
PROJECT_API int32 GetProxyNum(const TSharedPtr<FBasicProxy>& ProxySPtr); 

/**
 * 可被分配的接口
 */
struct PROJECT_API IProxy_Allocationble
{
private:
