...
USTRUCT()
struct PROJECT_API FItemProxyVisitor_Hover : public FItemProxyVisitor_Hover_Base
{
...
USTRUCT()
struct PROJECT_API FItemProxyVisitor_InAllocation : public FItemProxyVisitor_InAllocation_Base
{
	GENERATED_USTRUCT_BODY()
