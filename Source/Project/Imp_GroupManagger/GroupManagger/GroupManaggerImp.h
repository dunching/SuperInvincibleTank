...
#include "GroupManaggerImp.generated.h"
 ...
 */
UCLASS()
class PROJECT_API AGroupManaggerImp:
...
public:
	...
	AGroupManaggerImp(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
